				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<p className="text-green-500 mb-2">$ pwd</p>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/shashank-ssriva"
									target="_blank"
									rel="noopener noreferrer"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">shashank-ssriva</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/shashank-shekhar-srivastava/"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">Shashank Srivastava</p>
									</div>
								</motion.a>
								<motion.a
									href="https://twitter.com/shashanksriva"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@shashanksriva</p>
									</div>
								</motion.a>
								<motion.a
									href="https://shashanksrivastava.medium.com/"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@shashanksrivastava</p>
									</div>
								</motion.a>
							</div>
						</div>
